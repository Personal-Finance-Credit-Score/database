...
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (4, 1, 2438.0, 4.69, 44, 1, 0.74, 624.94, 11, 2, 1, 1, '2022-09-20');
...
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (6, 1, 12959.5, 4.01, 45, 1, 0.24, 9818.28, 34, 0, 1, 0, '2020-10-30');
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (7, 1, 25277.95, 4.2, 26, 1, 0.55, 11335.42, 12, 3, 1, 0, '2022-08-21');
...
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (10, 1, 40601.19, 6.51, 24, 4, 0.3, 28559.55, 17, 0, 1, 0, '2022-03-24');
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (11, 1, 27293.17, 12.45, 59, 3, 0.61, 10759.35, 23, 0, 1, 0, '2021-09-25');
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (12, 1, 34847.11, 6.41, 41, 4, 0.37, 22050.09, 26, 2, 1, 1, '2021-06-27');
...
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (14, 1, 44725.21, 12.08, 39, 4, 0.38, 27755.59, 24, 1, 0, 0, '2021-08-26');
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (15, 1, 35721.17, 11.91, 49, 4, 0.47, 18782.07, 26, 0, 2, 1, '2021-06-27');
...
INSERT INTO Loan (loan_id, customer_id, loan_amount, interest_rate, loan_term, loan_type_id, credit_utilization_ratio, amount_paid, number_of_payments, days_late_30, days_late_60, days_90_plus, date_opened) VALUES (17, 1, 7019.19, 6.38, 60, 3, 0.0, 6988.89, 60, 0, 1, 1, '2018-09-11');
